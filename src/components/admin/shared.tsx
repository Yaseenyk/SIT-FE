...
export const FIELD =
  "w-full rounded-lg border border-line bg-bg2 px-3 py-2 text-sm text-ink " +
  "placeholder:text-muted/70 focus:border-sky focus:outline-none disabled:opacity-50";
...
export function Notice({
  ...
  return (
    <div
      ...
      className={cn(
        "mb-4 flex items-start justify-between gap-3 rounded-lg border px-4 py-2.5 text-xs",
        tone === "ok"
