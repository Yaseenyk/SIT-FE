  ...
  return (
    <div className="min-h-screen bg-bg2">
      ...
      <main className="mx-auto max-w-5xl space-y-10 px-4 py-12 sm:px-6">
        ...
        <section className="card p-7">
          <div className="mb-6 flex flex-wrap items-baseline justify-between gap-3">
            <h2 className="font-display text-xl font-bold text-ink">My committee applications</h2>
            <Link href="/#join" className="text-sm font-semibold text-sky hover:underline">
...
function WithdrawButton({ id, onDone }: { id: string; onDone: () => void }) {
  ...
  return (
    <button
      ...
      className="mt-3 text-xs font-semibold text-muted hover:text-rose"
    >
